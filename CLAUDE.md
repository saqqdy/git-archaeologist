# Git Archaeologist — Claude Code Guide

## Project Overview

Git Archaeologist 是一个 Claude Code Skill 插件，将 `git blame` 从"谁写的"升级为"为什么这样写"——通过 AI 语义分析追溯代码决策历史。

## Architecture

```
.claude/skills/git-archaeologist/  ← Skill 定义（核心产品）
